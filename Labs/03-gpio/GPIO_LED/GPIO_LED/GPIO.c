 ...
 * Returns:  none
 **********************************************************************/
void GPIO_config_output(volatile uint8_t *reg_name, uint8_t pin_num) // ukazatel proto, že pøepíše promìnnou pøímo v místì, kde je uložena v pamìti, do funkce pošlu adresu promìnné, ona tam pracuje s její hodnotou 
{
    *reg_name = *reg_name | (1<<pin_num); // kdybychom volali pøímo registr a èíslo, zmìnil by lokální hodnotu zkopírovanou z registru, nikoliv registr
}
